...
fn run_parent(child_pid: usize) {
    ...
    println!("[parent] pid = {}, child = {}", self_pid, child_pid);
    ...
    println!(
        "[parent] got handshake ack len={}, bytes={:02x} {:02x}",
        got, ack[0], ack[1]
    );
    ...
    println!(
        "[parent] wrote overflow payload: requested={}, actual={}",
    ...
    println!(
        "[parent] got overflow ack len={}, bytes={:02x} {:02x} {:02x}",
    ...
    println!("[parent] write to invalid pid correctly rejected");
}
...
fn run_child() -> i32 {
    ...
    println!(
        "[child] handshake len={}, bytes[0]={:02x}",
        handshake_len, buf[0]
    );
    ...
    println!("[child] overflow len received = {}", overflow_len);
    ...
    println!("[child] sent overflow ack len={}", ack.len());
...
pub fn main() -> i32 {
    ...
    assert_eq!(code, 0);
    println!("\x1b[32mch7b_mailbox_limits passed\x1b[0m");
    0
}
